...
<body>
  ...
  <div class="about" id="about">
    ...
    <div class="section" id="motivation">
      ...
      <div class="text">
        <h1>Motivation</h1>
        <p>When I know, what I'm contributing to the project and at the end can say or see what I have done, then I'm really motivated to help and support it. My motivation to finish a project pushes me forwards until I almost see the finished product shimmering in front of my eyes. My goals are always to learn something new and interesting. Also, I want to get on the limits of something, trying, succeeding, and failing. Those are the most important things, that I really appreciate, that's also partially why I have chosen this job. </p>
      </div>
    </div>
    <div id="whyme">
      <div class="text">
        <h1>Why me?</h1>
        <p>So maybe you have already taken a picture of me, but why should you pick exactly me? Well, let me tell you. If I'd have to pick an animal that mostly describes me with its characteristics, I will say a cat, because it uses its energy the most efficient, in this case for hunting. They're also always looking forwards into the future, like me.<br> If you now want a young, productive, and interested man, that always knows what his tasks are, thinking in advance and caring about his team, then I'm the perfect candidate. </p>
      </div>
    </div>
  </div>
