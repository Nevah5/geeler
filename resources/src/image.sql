...
DROP TABLE IF EXISTS deleteTokens;
...
CREATE TABLE cookie(
  ...
  created TIMESTAMP(1) DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (userFK) REFERENCES users(ID)
);
...
CREATE TABLE deleteTokens(
  ID INT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
  userFK VARCHAR(32) NOT NULL,
  token VARCHAR(128) NOT NULL,
  created TIMESTAMP(1) DEFAULT CURRENT_TIMESTAMP(1),
  FOREIGN KEY (userFK) REFERENCES users(ID)
);
...
("DE", "login", "verification.success.title", "Verifizierungsemail:"),
("DE", "login", "verification.resend.success", "Die Email wurde erfolgreich erneut versendet."),
("DE", "login", "verification.resend.wait", "Bitte warte noch einen Moment."),
("DE", "login", "account.verify.resend", "Verifizierungsemail erneut senden."),
...
("DE", "login", "title.forgotpassword", "Passwort vergessen - geeler.net"),
...
("DE", "login", "forgotpassword.email.notexists", "Es gibt keinen Account mit dieser Email Adresse."),
("DE", "login", "forgotpassword.pw", "Dein neues Passwort"),
("DE", "login", "forgotpassword.pwrep", "Wiederhole das Passwort"),
("DE", "login", "forgotpassword.submit.send", "Email senden"),
("DE", "login", "forgotpassword.submit", "Neues Passwort setzen"),
("DE", "login", "passwordreset.message.tokeninvalid", "Dieser Token ist entweder ungültig oder abgelaufen."),
("DE", "login", "forgotpassword.email.changefor", "Passwort ändern für: $email"),
("DE", "login", "passwordreset.success.title", "Password reset:"),
("DE", "login", "passwordreset.success.text", "Your password has successfully changed!"),
...
("DE", "register", "accountlogin", "Du hast bereits ein Account erstellt? Logge dich <a href=""/login/"">hier</a> ein!"),
...
("DE", "account", "title", "Account - geeler.net"),
("DE", "account", "nav.settings", "Einstellungen"),
("DE", "account", "nav.profile", "Profil"),
("DE", "account", "nav.account", "Account"),
("DE", "account", "nav.security", "Sicherheit"),
("DE", "account", "logout", "Ausloggen"),
("DE", "account", "delete", "Löschen"),
("DE", "account", "sitenotdone", "Diese Seite ist noch nicht fertig."),
("DE", "account", "sitenotdone.text", "Ich werde bald neue Features hinzufügen, wenn ich mehr Zeit und Energie habe."),
("DE", "account", "security.password.change", "Passwort ändern"),
("DE", "account", "security.password.current", "Zurzeitiges Passwort"),
("DE", "account", "security.password.new", "Neues Password"),
("DE", "account", "security.password.repeat", "Password repetieren"),
("DE", "account", "security.password.submit", "Ändern"),
("DE", "account", "account.username", "Benutzername:"),
("DE", "account", "account.email", "Email:"),
("DE", "account", "account.joined", "Beigetreten:"),
("DE", "account", "account.getupdates", "Neuste Updates und News per Email:"),
("DE", "account", "account.banner", "Banner:"),
("DE", "account", "account.banner.change", "Banner ändern"),
("DE", "account", "account.banner.reset", "Banner zurücksetzen");
...
("EN", "home", "about.general.text", "Hi, I'm Noah Geeler. I'm 17 years old and doing an apprenticeship as an application developer in Zurich (Switzerland). I really like cats of any size and squirrels, because of their jumping skills, they're both my favourite animals.<br> My strengths are PHP and maybe CSS, because I've worked with them for a longer time and haven't focused on anything else. My weakness is French, because I really don't like the language.<br> When family members and friends describe me, they say that I'm always on time, clever and sometimes a nerd. "),
...
("EN", "login", "verification.success.title", "Verification email:"),
("EN", "login", "verification.resend.success", "The email was resent successfully."),
("EN", "login", "verification.resend.wait", "Please wait a bit."),
("EN", "login", "account.verify.resend", "Resend Verification Email"),
...
("EN", "login", "title.forgotpassword", "Forgot Password - geeler.net"),
...
("EN", "login", "forgotpassword.email.notexists", "There is no account with this email."),
("EN", "login", "forgotpassword.pw", "Your new password"),
("EN", "login", "forgotpassword.pwrep", "Repeat the new password"),
...
("EN", "register", "accountlogin", "You already have an account? Login <a href=""/login/"">here</a>!"),
...
("EN", "account", "title", "Account - geeler.net"),
("EN", "account", "nav.settings", "Settings"),
("EN", "account", "nav.profile", "Profile"),
("EN", "account", "nav.account", "Account"),
("EN", "account", "nav.security", "Security"),
("EN", "account", "logout", "Logout"),
("EN", "account", "delete", "Delete"),
("EN", "account", "sitenotdone", "This site is not done yet"),
("EN", "account", "sitenotdone.text", "I will add more features soon, when I got time and more energy, so please be patient."),
("EN", "account", "security.password.change", "Change Password"),
("EN", "account", "security.password.current", "Current Password"),
("EN", "account", "security.password.new", "New Password"),
("EN", "account", "security.password.repeat", "Repeat Password"),
("EN", "account", "security.password.submit", "Change"),
("EN", "account", "account.username", "Username:"),
("EN", "account", "account.email", "Email:"),
("EN", "account", "account.joined", "Joined:"),
("EN", "account", "account.getupdates", "Get recent updates and news per email:"),
("EN", "account", "account.banner", "Banner:"),
("EN", "account", "account.banner.change", "Change Banner"),
("EN", "account", "account.banner.reset", "Reset Banner");
