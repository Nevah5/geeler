...
<head>
  ...
  <link rel="stylesheet" href="../copyright/style.css">
  <link rel="icon" href="/resources/icons/logo.png">
  <title>${acknownledgements.title}</title>
</head>
<body>
  <a href="/" class="logo"><span>geeler</span></a>
  <form action="index.php" method="POST">
    <div class="content">
      <h2>${footer.stuff.acknownledgements}</h2>
      <div class="wrapper">
        <div class="box">
          <p>
          <?php
            $file = file_get_contents("ACKNOWNLEDGEMENTS");
            echo $file;
          ?>
          </p>
        </div>
