...
<body>
  ...
  <div id="compile">
    ...
    <a href='compile.php?input=login_2FA.php&lang=<?= $lang ?>&output=login/2FA/index.php'>Login/2FA</a>
    <a href='compile.php?input=login_forgotpassword.php&lang=<?= $lang ?>&output=login/forgotpassword/index.php'>Login/Forgotpassword</a>
    ...
    <a href='compile.php?input=footer.php&lang=<?= $lang ?>&output=resources/footer/footer.php'>Footer</a>
    ...
    <a href='compile.php?input=acknownledgements.php&lang=<?= $lang ?>&output=acknownledgements/index.php'>Acknownledgements</a>
    <a href='compile.php?input=account.php&lang=<?= $lang ?>&output=account/index.php'>Account</a>
  </div>
  <?php
