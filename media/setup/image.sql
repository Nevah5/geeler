...
("DE", "title", "login", "Einloggen - geeler.net"),
("DE", "login", "title", "Einloggen"),
...
("DE", "title", "register", "Registrieren - geeler.net"),
("DE", "register", "title", "Registrieren"),
...
("DE", "register", "error.usernameinvalid", "Dieser Benutzername ist nicht gültig. [3-32 Zeichen, keine \'^£$%&*()}{@#~?><>,|=_+¬-]"),
...
("EN", "title", "login", "Login - geeler.net"),
...
("EN", "title", "register", "Register - geeler.net"),
...
("EN", "register", "error.usernameinvalid", "This username is not valid. [3-32 characters, no \'^£$%&*()}{@#~?><>,|=_+¬-]"),
