  ...
  function register_user($u, $e, $p, $ads){
    ...
    <body>
      <div>
        <div class='main'>
          ...
          <div class='body'>
            <a href='https://dev.geeler.net/verify?token=$verifyToken'>
              Verify your Account
            </a>
          </div>
          <footer>
            <span>©️ 2021 - geeler.net</span>
          </footer>
        </div>
      </div>
    </body>
    <style>
      ...
      div > div.main{
        ...
        border-left: #0d3263 solid 3px;
        border-right: #0d3263 solid 3px;
        width: 70%;
        height: 100%;
        position: relative;
        min-height: 600px;
      ...
      .body{
        ...
        background-image: url('https://dev.geeler.net/media/backgrounds/triangles.svg');
